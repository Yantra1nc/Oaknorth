    ...
    function onRequest(context) {
        ...
        try {
            ...
            if (context.request.method == 'GET') {
                ...
                var header_str = "Bill,Accounting Date, Due Date, Transaction No, Vendor Name, Amount to be Paid, Amount Due, Total Amount, Tax Amount, Location, Benificiary Bank Name, Benificiary Bank Account No,IFSC Code \n"
                var line_str = "";
